...
OPENAI_CLASSIFIER_TIMEOUT_SECONDS = get_env_float("OPENAI_CLASSIFIER_TIMEOUT_SECONDS", 6.0)
OPENAI_GENERATION_TIMEOUT_SECONDS = get_env_float("OPENAI_GENERATION_TIMEOUT_SECONDS", 25.0)

RAG_TOP_K = get_env_int("RAG_TOP_K", 3)
...
MAX_OUTPUT_TOKENS = get_env_int("MAX_OUTPUT_TOKENS", 450)
